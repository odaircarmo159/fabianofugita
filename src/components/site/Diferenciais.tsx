...
export function Diferenciais() {
  return (
    <section className="overflow-hidden border-t border-[#8d4642] bg-[linear-gradient(180deg,#7a2c2d_0%,#642224_100%)] text-bone">
      <div className="mx-auto max-w-[1600px] px-4 py-20 sm:px-6 sm:py-24 lg:px-12">
        <div className="grid grid-cols-12 gap-10 lg:gap-14">
          <div className="reveal col-span-12 min-w-0 md:col-span-4">
            ...
            <h2 className="mt-5 max-w-full text-balance font-serif text-[28px] leading-[1.02] sm:mt-6 sm:text-[42px] md:text-[60px]">
              Um atendimento mais <em className="italic text-[#e0bb8d]">próximo e claro</em>.
            </h2>
            <p className="mt-5 max-w-full [overflow-wrap:anywhere] text-[14px] leading-relaxed text-bone/78 sm:mt-6 sm:max-w-md sm:text-[17px]">
          ...
          <div className="col-span-12 min-w-0 md:col-span-8">
            {differentiators.map((item, index) => (
              ...
              >
                ...
                <div className="min-w-0 w-full max-w-full sm:max-w-[760px]">
                  <h3 className="max-w-full break-words [overflow-wrap:anywhere] font-serif text-[18px] leading-[1.06] text-bone sm:max-w-[18ch] sm:text-[28px]">
                    {item.title}
                  </h3>
                  <p className="mt-3 max-w-full break-words [overflow-wrap:anywhere] text-[14px] leading-relaxed text-bone/78 sm:max-w-[42ch] sm:text-[16px]">
                    {item.description}
                  </p>
                </div>
              </article>
