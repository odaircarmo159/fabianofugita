...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-50 inline-flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-2.5 text-[12px] font-semibold text-white shadow-[0_18px_42px_rgba(37,211,102,0.28)] transition-transform duration-300 hover:scale-[1.03] sm:bottom-5 sm:right-5 sm:gap-3 sm:px-5 sm:py-3 sm:text-[13px] md:bottom-6 md:right-6"
    >
      <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/18 sm:h-10 sm:w-10">
